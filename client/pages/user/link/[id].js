...
const UpdateLink = ({ oldLink, token }) => {
  ...
  const handleUpdateResourceLink = async e => {
    ...
    try {
      ...
      setState({
        ...state,
        success: "Resource Link was Updated!",
      })
    } catch (err) {
    ...
    <Layout>
      ...
      <div className='row' style={{ marginTop: 100 }}>
        <div className='col-md-12'>
          <h2 className='text-center'>Update Resource Link</h2>
          <br />
          <div className='row'>
            ...
            <div className='col-md-8'>
              ...
              <form onSubmit={handleUpdateResourceLink}>
                <div className='form-group'>
...
UpdateLink.getInitialProps = async ({ req, token, query }) => {
