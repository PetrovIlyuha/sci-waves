...
var Register = function Register() {
  ...
  var handleFormSubmit = function handleFormSubmit(e) {
    e.preventDefault();
    axios__WEBPACK_IMPORTED_MODULE_2___default.a.post("http://localhost:4000/api/register", {
      name: name,
      email: email,
      password: password
    });
